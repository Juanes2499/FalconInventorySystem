    ...
    public partial class TablesCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillOrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillOrderItems_BillOrders_BillOrderId",
                        column: x => x.BillOrderId,
                        principalTable: "BillOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillOrderItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillOrderItems_TransactionStates_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_TransactionStates_StateId",
                        column: x => x.StateId,
                        principalTable: "TransactionStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillOrderItems_BillOrderId",
                table: "BillOrderItems",
                column: "BillOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_BillOrderItems_ProductId",
                table: "BillOrderItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemTransactions_WarehouseId",
                table: "ItemTransactions",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_StateId",
                table: "PurchaseOrderItems",
                column: "StateId");
